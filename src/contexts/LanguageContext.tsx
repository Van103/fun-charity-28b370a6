...
export const translations: Translations = {
  ...
  "honor.topProfile": { en: "Total Featured Profiles", vi: "Tổng Hồ Sơ Nổi Bật" },
  "honor.earnings": { en: "Total Income", vi: "Tổng Thu Nhập" },
  "honor.posts": { en: "Total Posts", vi: "Tổng Bài Viết" },
  "honor.videos": { en: "Total Videos", vi: "Tổng Video" },
  "honor.friends": { en: "Total Friends", vi: "Tổng Bạn Bè" },
  "honor.nftCount": { en: "Total NFTs", vi: "Tổng NFT" },
  "honor.campaigns": { en: "Total Campaigns", vi: "Tổng Chiến Dịch" },
  "honor.donations": { en: "Total Donations", vi: "Tổng Quyên Góp" },
  "honor.comments": { en: "Total Comments", vi: "Tổng Bình Luận" },
